...
public class TelekinesisEnchantment extends Enchantment implements _IEnchantmentExtensions
{
    ...
    static
    {
        EntityItemDropCallback.BEFORE.register(((entity, item, source) ->
        {
            ...
            int level;
            if(source.getSource() instanceof PersistentProjectileEntity persistent)
                level = EnchantmentHelper.getLevel(ModEnchantments.TELEKINESIS, persistent.getItemStack());
            else
